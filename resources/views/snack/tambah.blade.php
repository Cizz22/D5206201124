        ...
        <div class="card-body p-5">
            <form action="/snack/store" method="post">
                ...
                <div class="form-group form ">
                    ...
                    <input type="text" class="form-control" name="merksnack" required="required"> <br/>
                </div>
                <div class="form-group form">
                    <label for="">Stock Snack </label>
                    <input type="number" class="form-control" name="stocksnack" required="required"> <br/>
                </div>
                <div class="form-group">
                    <label for="">Status Snack</label>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" value="Y" name="status" id="flexRadioDefault2" checked>
                        <label class="form-check-label"  for="flexRadioDefault2">
                             <p class="ml-4">Tersedia</p>
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input"  type="radio" value="N" name="status" id="flexRadioDefault2">
                        <label class="form-check-label" for="flexRadioDefault2">
